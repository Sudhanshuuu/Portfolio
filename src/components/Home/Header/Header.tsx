    ...
    return (
        <div className="flex justify-center h-[90vh] sm:h-[80vh] md:px-[5%] lg:px-[10%]">
            <div className=" w-[80%] flex justify-center flex-col md:w-[50%]">
                ...
                <div className="my-[3%]">I wasn't a code lover before college; my journey into coding began the moment I entered college. I wasn't sure what I wanted to do or how to do it. But as soon as I started the learning process, I fell in love with it. The process of learning, creating, and getting better at something thrives me.</div>
                <div className="flex">
                    ...
                    <button className="mx-2 text-sm bg-black text-white px-4 py-3 rounded-3xl border border-black transition duration-200 hover:bg-white hover:text-black">
