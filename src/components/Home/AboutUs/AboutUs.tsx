                    ...
                    <div className="flex px-[5%]">
                        ...
                        <div className={`${index === 0 ? 'relative opacity-100' : 'absolute opacity-0'} transition duration-700 mx-[2%]`}>
                            ...
                            <div className="flex justify-center flex-col my-6">
                                <div className="flex my-2 w-[50%] text-sm"><Image src="/Icon/user.png" height={20} width={20} alt="icon" /><div className="mx-1">Sudhanshu Singh</div></div>
                                <div className="flex my-2 w-[50%] text-sm"><Image src="/Icon/email.png" height={20} width={20} alt="icon" /><div className="mx-1">sudhanshusingh9754@gmail.com</div></div>
                                ...
                                <div className="flex my-2 w-[50%] text-sm"><Image src="/Icon/calendar.png" height={20} width={20} alt="icon" /><div className="mx-1">Born on 6th Aug</div></div>
                            </div>
                        ...
                        <div className={`${index === 1 ? 'relative opacity-100' : 'absolute opacity-0'} transition duration-700 mx-[2%] w-[100%]`}>
                            ...
                            <div className="flex flex-col md:flex-row">
                                <div className="mx-[5%]">
                                    ...
                                    <div className="my-3 border-l pl-4">
                                        <div>NayePankh Foundation</div>
                                        <div className=" text-slate-600 text-sm">Web Developer</div>
                                        <div className="mt-3 text-sm">2023-2023</div>
                                    </div>
                                </div>
                                <div className="mx-[5%]">
                        ...
                        <div className={`${index === 2 ? 'relative opacity-100' : 'absolute opacity-0'} transition duration-700 mx-[2%]`}>
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="my-1"><span className="font-semibold mx-1">Languages :</span> JavaScript, HTML5, CSS, TypeScript, C, C++</div>
